...
exports.parseGeneral = BBPromise.method(function(chtml){
	var clutteredMeta = {
		...
		description: chtml('meta[name=description i]').first().attr('content'), //meta description <meta name ="description" content="">
		keywords: chtml('meta[name*=keywords i], meta[name*=tags i]').attr('content'), //meta keywords <meta name ="keywords" content="">
		...
		section: chtml('meta[name*=section i], meta[property*=section i]').first().attr('content'), //robots <meta name ="section" content="">
